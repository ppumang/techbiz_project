...
if __name__ == '__main__':
    ...
    LDA_0.save(directory, 'test.xlsx', data=data_input)
    ...
    pyLDAvis.save_html(vis_data, directory + 'ldavis_test.html')
    ...
    # plt.show()
    plt.savefig(directory+'portfolio.png', dpi=1000, bbox_inches='tight',)
